<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xinxi.aspx.cs" Inherits="EmptyProjectNet45_FineUI.xinxi" %>
    ...
    <div>
        <div class="line">
                ...
                <asp:GridView ID="GridView2" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" CssClass="gridview"
                    ...
                    <Columns>
                        <asp:BoundField DataField="ordd" HeaderText="序号" ReadOnly="True" SortExpression="ordd" />
                        ...
                        <asp:BoundField DataField="sushe" HeaderText="宿舍" SortExpression="sushe" />
                        <asp:BoundField DataField="xueyuan" HeaderText="学院" SortExpression="xueyuan" />
