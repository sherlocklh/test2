                ...
                <f:Region ID="Region2" Split="true" Width="200px" ShowHeader="true" Title="菜单"
                    ...
                    <Items>
                        <f:Tree runat="server" ShowBorder="false" ShowHeader="false" EnableArrows="true" EnableLines="true" ID="leftMenuTree">
                            <Nodes>
                                <f:TreeNode Text="分类" Expanded="true">
                                    <f:TreeNode Text="学生成绩查询" NavigateUrl="~/xuesheng.aspx"></f:TreeNode>
                                    <f:TreeNode Text="学生成绩维护" NavigateUrl="~/hello.aspx"></f:TreeNode>
                                    <f:TreeNode Text="学生信息维护" NavigateUrl="~/xinxi.aspx"></f:TreeNode>
                                    <f:TreeNode Text="留言页面" NavigateUrl="~/contact.aspx"></f:TreeNode>
                                </f:TreeNode>
                            </Nodes>
                        </f:Tree>
                    </Items>
