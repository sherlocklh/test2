...
<body style="background-image:url(图片/16137632_1354005593653.jpg); background-repeat:no-repeat;">
    <div style="float: left;">
        <br />
        <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: black;font-family:  Microsoft YaHei;font-size: 40px">学生成绩管理<br></span></div>
        ...
        <f:Window ID="Window1" runat="server" Title="登录" IsModal="false" EnableClose="false"
            ...
            <Toolbars>
                <f:Toolbar ID="Toolbar1" runat="server" Position="Bottom" ToolbarAlign="Right">
                    <Items>
                        <f:Button ID="btton" Text="学生登陆" Type="Submit" ValidateForms="SimpleForm1" ValidateTarget="Top" runat="server" OnClick="btton_Click"></f:Button>
                        <f:Button ID="btnLogin" Text="教师登录" Type="Submit" ValidateForms="SimpleForm1" ValidateTarget="Top" runat="server" OnClick="btnLogin_Click"></f:Button>
